<?php function sidebar_(){ ?>
	
	<!-- Sidebar Here -->
  <nav class="sidebar sidebar-offcanvas" id="sidebar">
  <div class="text-center">
  <a href="index.php"><img src="assets/images/paris-logo.png" class="paris_logo" style="width:50%;margin:0 auto; text-align:center;" /></a>
  </div>
  <ul class="nav">
    ...
    <li class="nav-item">
      <a class="nav-link" data-bs-toggle="collapse" href="#general-pages1" aria-expanded="false" aria-controls="general-pages1">
        <span class="menu-title">Add Admins/Roles</span>
      ...
      <div class="collapse" id="general-pages1">
        <ul class="nav flex-column sub-menu">
          ...
          <li class="nav-item"> <a class="nav-link" href="add_sub_admin.php"> Add Sub Admin </a></li>
        </ul>
      </div>
    </li>
